    ...
    <el-dialog
      ...
      <el-form ref="elForm" :model="formData"  label-width="100px" size="medium">
        ...
        <el-form-item label="部门" prop="department_fid">
          <el-select v-model="formData.department_fid" :disabled="disabled" placeholder="请选择部门">
            <el-option
        ...
        <el-form-item label="指标名称" prop="name">
          <el-input v-model="formData.name"  :style="{width: '100%'}" clearable placeholder="请输入指标名称" ></el-input>
        </el-form-item>
        ...
        <el-form ref="elForm2" :model="formData2"  label-width="85px" size="small">
          <el-col :span="6">
            <el-row>
              <el-col :span="24">
                <el-form-item label="指标名称" prop="name">
                  <el-input v-model="formData2.name" :style="{width: '100%'}" clearable placeholder="请输入指标名称">
                  </el-input>
                </el-form-item>
              </el-col>
            </el-row>
          ...
          <el-col :span="24">
            <el-form-item size="large">
              <el-button type="primary" size="small" plain @click="addUser">添加指标</el-button>
            </el-form-item>
          </el-col>
        </el-form>
      </el-row>
...
<script>
import { getDepartment,getProxy,delProxy,insertProxyOrUpdate} from "../../api/index"
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    ...
    addFn() {
      this.$refs['elForm'].validate(valid => {
        ...
        insertProxyOrUpdate(this.formData).then(res=>{
          if(res.flag){
            this.$nextTick(()=>{
